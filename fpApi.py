...
class FpApi(IntEnum):
    """Enumeration of FP-side DECT API message IDs."""
    ...
    API_ISP_IDENTIFY_REQ = 0x47D0
    API_ISP_IDENTIFY_CFM = 0x47D1
    API_ISP_ERASE_REQ = 0x47D2
    API_ISP_ERASE_CFM = 0x47D3
    API_ISP_WRITE_REQ = 0x47D4
    API_ISP_WRITE_CFM = 0x47D5
    API_ISP_CRC_REQ = 0x47D6
    API_ISP_CRC_CFM = 0x47D7
    API_ISP_EMPTY_REQ = 0x47D8
    API_ISP_EMPTY_CFM = 0x47D9
    API_ISP_MD5_REQ = 0x47DA
    API_ISP_MD5_CFM = 0x47DB
    API_ISP_WRPTR_REQ = 0x47DC
    ...
    API_FP_WIFI_EXCLUDE_REQ = 0x4900
